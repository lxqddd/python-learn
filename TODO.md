...
- [ ] 10 个练习全部完成
- [ ] `02-weather-llm` 项目能跑
- [ ] **关键测试**：打开 [LangChain `core/runnables/base.py`](https://github.com/langchain-ai/langchain) 能读懂 60% 以上
- [ ] 不熟悉的知识点列出来，W4 之前补完

---

## 🚀 阶段 2 · First 7 Days Sprint（W4 · 14h）
...
### W4 · D4 周四 · 2h — Context Engineering

- [ ] **[90min]** 实现 `prompts.py` 5 层 context builder
- [ ] **[30min]** 跑同任务 2 次，对比 prompt 结构稳定性
- [ ] **验收**：[ ] 同任务 prompt 结构稳定 + [ ] 5 层命名清晰

### W4 · D5 周五 · 2h — 20 条 Eval

- [ ] **[60min]** 写 20 条 eval cases（10 正常 + 5 边界 + 5 安全）→ `eval_cases.jsonl`
...
## 📚 阶段 3 · RAG 完整链路（W5-6 · 40h）

### W5 · D1 周一 · 2h — FastAPI 入门
...
### W5 · D4 周四 · 2h — 向量库 Chroma

- [ ] **[40min]** 看 [Chroma 入门](https://docs.trychroma.com/getting-started)
- [ ] **[40min]** 学持久化存储 + 元数据过滤
- [ ] **[40min]** 把 W5D2 PDF chunks 存入 Chroma，查询返回 top-k
- [ ] **验收**：[ ] Chroma 持久化 + [ ] 相似度检索可用

### W5 · D5 周五 · 2h — 端到端 Naive RAG
...
## 🕸 阶段 4 · Agent 框架（W7-8 · 40h）

### W7 · D1 周一 · 2h — LangGraph 入门

- [ ] **[60min]** 看 [LangGraph Quickstart](https://langchain-ai.github.io/langgraph/)
- [ ] **[60min]** 用 LangGraph 重写 W4 的最小 Agent
- [ ] **验收**：[ ] StateGraph 跑通
...
### W7 · D3 周三 · 2h — Conditional Edge

- [ ] **[40min]** 学路由函数 + 循环检测
- [ ] **[80min]** 练习：根据"是否需要工具"决定下一步
- [ ] **验收**：[ ] 不会无限循环 + [ ] 决策可视化

### W7 · D4 周四 · 2h — Checkpoint 持久化
...
### W10 · D5 周五 · 2h — Docker Compose 完善

- [ ] **[60min]** 多服务编排（RAG + Chroma + Redis + LangSmith）
- [ ] **[30min]** 环境变量管理 + 健康检查
- [ ] **[30min]** 写部署文档
- [ ] **验收**：[ ] 一键 `docker compose up` 全跑
...
### W14 · D3 周三 · 2h — LeetCode + 算法

- [ ] **[30min]** LeetCode Hot 100（数组 / 字符串 / 哈希）
- [ ] **[90min]** LeetCode Hot 100（链表 / 二叉树）
- [ ] **验收**：[ ] 至少 5 题能用最优解讲清
