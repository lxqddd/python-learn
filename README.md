...
| **7** 求职冲刺 | 第 14-16 周 | 简历 + 投递 + 模拟面试 | ⬜ |

> **总时长**：17 周（原 14 周 · 增加 1 周 Python 强化 + 增加 2 周求职冲刺）
...
5. **每周日最后 10min 读行业动态** — [Simon Willison](https://simonwillison.net/) / [LangChain Blog](https://blog.langchain.com/) / [Anthropic Blog](https://www.anthropic.com/engineering)；求职时会被问"你怎么看 2026 Agent 趋势"
...
- 📋 **17 周定制学习路线**（每天任务、验收标准）→ [`docs/learning-roadmap.md`](docs/learning-roadmap.md)
- 📖 全部学习资源 → [`resources.md`](resources.md)
- 🚀 7 天冲刺任务清单 → [`docs/first-7-days-checklist.md`](docs/first-7-days-checklist.md)
- 🧪 Eval case 模板 → [`docs/eval-case-template.md`](docs/eval-case-template.md)
